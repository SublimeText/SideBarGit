...
from SideBarGit.SideBarAPI import SideBarSelection
from SideBarGit.SideBarAPI import SideBarItem

from SideBarGit.SideBarGit import SideBarGit
...
class SideBarGitDiffAllChangesSinceLastCommitCommand(sublime_plugin.WindowCommand):
    def run(self, paths=[]):
        for item in SideBarSelection(paths).getSelectedItems():
            ...
            object.syntax_file = 'Packages/SideBarGit/other/DiffSideBarGit.hidden-tmLanguage'
